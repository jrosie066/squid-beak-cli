const {
  createEnhancerFile, createIndexFile, createComponentFile, createStyleSheet, createStorybook
...
describe('Shared File Creators', () => {
  ...
  describe('#createStorybook', () => {
    it('should create storybook file with enhancer import', () => {
      options.useEnhancer = true;
      createStorybook(componentName, root, options);
      expect(writeSyncSpy).toHaveBeenCalledWith(
        expect.stringContaining('stories.js'),
        expect.stringContaining(`import ${componentName} from '..';\n\n`)
      );
    });
    it('should create storybook file without enhancer import', () => {
      ...
      expect(writeSyncSpy).toHaveBeenCalledWith(
        expect.stringContaining('stories.js'),
        expect.stringContaining(`import ${componentName} from '../${componentName}.tsx';\n\n`)
      );
    });
  });
});